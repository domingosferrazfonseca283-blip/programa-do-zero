...
object ContentRepository {
    ...
    private val pythonReviewQuestions = mapOf(
        "python-01" to ReviewQuestion("python-01-q1", "O que é programação?", listOf("Criar instruções para um computador", "Montar um computador", "Somente escrever textos", "Usar internet", 1, "Pensamento computacional"), 0, "Programação consiste em criar instruções executáveis para resolver tarefas."),
        "python-02" to ReviewQuestion("python-02-q1", "Para que serve uma variável?", listOf("Guardar um valor", "Desligar o computador", "Criar uma senha", "Abrir um arquivo", 1, "Variáveis"), 0, "Uma variável associa um nome a um valor."),
        "python-03" to ReviewQuestion("python-03-q1", "Qual é um valor booleano?", listOf("True", "20", "Ana", "1.5", 1, "Tipos de dados"), 0, "Booleanos representam verdadeiro ou falso."),
        "python-04" to ReviewQuestion("python-04-q1", "Quando o bloco if é executado?", listOf("Quando a condição é verdadeira", "Sempre", "Nunca", "Somente depois de um for", 1, "Condições"), 0, "O if escolhe um caminho quando sua condição é verdadeira."),
        "python-05" to ReviewQuestion("python-05-q1", "Para que serve um laço?", listOf("Repetir uma tarefa", "Criar uma variável", "Apagar código", "Fechar o aplicativo", 1, "Repetições"), 0, "Laços automatizam repetições."),
        "python-06" to ReviewQuestion("python-06-q1", "O que um parâmetro fornece?", listOf("Dados para uma função", "Energia ao computador", "Um arquivo", "Uma senha", 2, "Funções"), 0, "Parâmetros permitem que funções recebam dados."),
        "python-07" to ReviewQuestion("python-07-q1", "Qual é o primeiro índice de uma lista Python?", listOf("0", "1", "-1", "10", 2, "Listas"), 0, "Python usa indexação baseada em zero."),
        "python-08" to ReviewQuestion("python-08-q1", "Quais são partes comuns de um programa?", listOf("Entrada, processamento e saída", "Tela, teclado e mouse", "Arquivo, pasta e rede", "Classe, objeto e servidor", 2, "Projetos"), 0, "Esse fluxo representa uma estrutura básica de processamento."),
        "python-09" to ReviewQuestion("python-09-q1", "Como acessar aluno['nome']?", listOf("Pela chave nome", "Pelo índice 0", "Com input()", "Com range()", 2, "Dicionários"), 0, "Dicionários são acessados por chaves."),
        "python-10" to ReviewQuestion("python-10-q1", "O que upper() faz?", listOf("Converte para maiúsculas", "Apaga o texto", "Converte para números", "Cria uma lista", 2, "Strings"), 0, "upper() retorna uma versão em letras maiúsculas."),
        "python-11" to ReviewQuestion("python-11-q1", "Para que serve except?", listOf("Tratar uma exceção", "Criar uma classe", "Repetir um laço", "Ler uma lista", 2, "Erros"), 0, "except define o tratamento quando uma exceção ocorre."),
        "python-12" to ReviewQuestion("python-12-q1", "Qual modo abre arquivo para leitura?", listOf("r", "w", "a", "x", 2, "Arquivos"), 0, "O modo r é usado para leitura."),
        "python-13" to ReviewQuestion("python-13-q1", "O que é um objeto?", listOf("Uma instância de uma classe", "Sempre um arquivo", "Uma função global", "Um comentário", 3, "Orientação a objetos"), 0, "Um objeto é uma instância concreta de uma classe."),
        "python-14" to ReviewQuestion("python-14-q1", "O que a orientação a objetos organiza?", listOf("Estado e comportamento", "Somente textos", "Somente arquivos", "A conexão Wi-Fi", 3, "Organização de sistemas"), 0, "Classes ajudam a organizar estado e comportamento das entidades."),
        "python-15" to ReviewQuestion("python-15-q1", "O que é um acumulador?", listOf("Uma variável que guarda um resultado parcial", "Um arquivo", "Um tipo de erro", "Uma classe", 3, "Algoritmos"), 0, "O acumulador é atualizado durante uma sequência de operações."),
        "python-16" to ReviewQuestion("python-16-q1", "Como funciona uma busca sequencial?", listOf("Verifica os itens em ordem", "Escolhe sempre o último item", "Ordena tudo automaticamente", "Apaga itens", 3, "Algoritmos"), 0, "A busca sequencial examina os elementos um por um."),
        "python-17" to ReviewQuestion("python-17-q1", "Por que validar dados?", listOf("Para rejeitar entradas inválidas", "Para aumentar a tela", "Para apagar variáveis", "Para criar classes", 3, "Qualidade e testes"), 0, "Validação protege as regras do programa."),
        "python-18" to ReviewQuestion("python-18-q1", "Qual é uma vantagem de funções pequenas?", listOf("Separar responsabilidades", "Eliminar todos os testes", "Evitar variáveis", "Impedir reutilização", 3, "Arquitetura"), 0, "Responsabilidades menores facilitam manutenção e testes."),
        "python-19" to ReviewQuestion("python-19-q1", "O que análise de eficiência ajuda a avaliar?", listOf("O trabalho e recursos usados", "A cor do aplicativo", "O nome do computador", "A velocidade da internet", 3, "Eficiência"), 0, "Eficiência considera recursos necessários para executar uma solução."),
        "python-20" to ReviewQuestion("python-20-q1", "O que fazer antes de implementar um projeto?", listOf("Entender requisitos e dividir o problema", "Escrever tudo de uma vez", "Ignorar entradas", "Evitar testes", 3, "Projetos profissionais"), 0, "Entender o problema reduz retrabalho e orienta a implementação.")
    )
