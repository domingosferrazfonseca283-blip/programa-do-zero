...
object ContentRepository {
    ...
    private val pythonReviewQuestions = mapOf(
        ...
        "python-15" to ReviewQuestion("python-15-q1", "O que é um acumulador?", listOf("Uma variável que guarda um resultado parcial", "Um arquivo", "Um tipo de erro", "Uma classe"), 0, "O acumulador é atualizado durante uma sequência de operações."),
        "python-16" to ReviewQuestion("python-16-q1", "Como funciona uma busca sequencial?", listOf("Verifica os itens em ordem", "Escolhe sempre o último item", "Ordena tudo automaticamente", "Apaga itens"), 0, "A busca sequencial examina os elementos um por um."),
        "python-17" to ReviewQuestion("python-17-q1", "Por que validar dados?", listOf("Para rejeitar entradas inválidas", "Para aumentar a tela", "Para apagar variáveis", "Para criar classes"), 0, "Validação protege as regras do programa."),
        "python-18" to ReviewQuestion("python-18-q1", "Qual é uma vantagem de funções pequenas?", listOf("Separar responsabilidades", "Eliminar todos os testes", "Evitar variáveis", "Impedir reutilização"), 0, "Responsabilidades menores facilitam manutenção e testes."),
